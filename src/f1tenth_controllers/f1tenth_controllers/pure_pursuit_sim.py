...
class PurePursuitController(Node):
    ...
    def drive(self):  # main controller function for the robot
        ...
        self. yaw = tf_transformations.euler_matrix(self.yaw[0], self.yaw[1], self.yaw[2])
        ...
        if self.i % 20 == 0:
            self.get_logger().info(f'Current index: {self.current_index}, Target index: {self.target_index}, Steering angle: {steering_angle}, linear control: {lin_cntrl*self.timer_period}, angular control: {angular_cntrl*self.timer_period}')
