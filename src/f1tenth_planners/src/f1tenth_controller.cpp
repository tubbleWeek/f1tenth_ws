...
namespace nav2_controller {
        ...
        const std::shared_ptr<nav2_costmap_2d::Costmap2DROS> & costmap_ros)
    {
        ...
        declare_parameter_if_not_declared(
            node, name_ + ".desired_linear_vel", rclcpp::ParameterValue(
            0.2));
        declare_parameter_if_not_declared(
            node, name_ + ".lookahead_dist",
            rclcpp::ParameterValue(0.4));
        declare_parameter_if_not_declared(
            node, name_ + ".max_angular_vel", rclcpp::ParameterValue(
            1.0));
        declare_parameter_if_not_declared(
            node, name_ + ".transform_tolerance", rclcpp::ParameterValue(
            0.1));
    ...
    { // Issue original controller gives velocity commands in geometry_msgs::msg::TwistStamped but want AckermannDriveStamped format
...
PLUGINLIB_EXPORT_CLASS(nav2_controller::PurePursuitController, nav2_core::Controller)