...
class LocalMapNode(Node):
    def __init__(self):
        ...
        # Car radius
        self.car_radius = 0.5  # Define the car's radius in meters
    ...
    def inflate_obstacles(self):
        ...
        # Inflate the costmap: mark cells within the inflation radius
        self.costmap[distances <= self.inflation_cells] = 100
